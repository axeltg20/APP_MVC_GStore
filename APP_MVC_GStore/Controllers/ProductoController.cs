...
namespace APP_MVC_GStore.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idProd,nomProd,precio,descripcion,foto,idCategoria,stock,estado")] TB_Producto tB_Producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idProd,nomProd,precio,descripcion,foto,idCategoria,stock,estado")] TB_Producto tB_Producto)
        {
            if (ModelState.IsValid)
            {
