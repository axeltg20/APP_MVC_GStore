...
namespace APP_MVC_GStore.Models
{
    ...
    public partial class GameStoreEntities : DbContext
    {
        ...
        public virtual int usp_CrearUsuario(string nombre, string apellido, string celular, string email, string contra)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_CrearUsuario", nombreParameter, apellidoParameter, celularParameter, emailParameter, contraParameter);
        }
